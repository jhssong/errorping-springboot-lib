...
public class ErrorpingAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public StartupShutdownNotification startupShutdownNotification(ErrorpingProperties props,
                                                                   ErrorpingService errorpingService) {
        return new StartupShutdownNotification(props, errorpingService);
    }
